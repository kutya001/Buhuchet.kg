...
export function AccessDeniedCard({ moduleName = 'данному модулю', actionName }: AccessDeniedCardProps) {
  return (
    <div className="flex items-center justify-center p-6 min-h-[60vh]">
      <Card className="max-w-md w-full bg-slate-900/60 border-amber-500/30 text-white shadow-xl">
        <CardHeader className="text-center pb-2 pt-6">
          ...
          <CardTitle className="text-lg font-bold text-white">403 — Доступ Запрещен</CardTitle>
        ...
        <CardContent className="space-y-4 pt-2 text-center text-xs">
          ...
          <Link href="/dashboard" className="inline-block w-full">
            <Button className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs min-h-[40px] rounded-xl">
