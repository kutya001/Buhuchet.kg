...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Да, при регистрации любой тарифный план активируется в бесплатном тестовом режиме на 7 дней с полным доступом ко всем возможностям документооборота, облачного диска и Telegram-бота.',
  },
  {
