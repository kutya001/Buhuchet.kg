    ...
    permissions: [
      {
        ...
        uiTarget: 'Страница /dashboard/counterparties',
    ...
    permissions: [
      {
        ...
        uiTarget: 'Страница /dashboard/employees',
    ...
    permissions: [
      {
        ...
        uiTarget: 'Страница /dashboard/files',
    ...
    permissions: [
      {
        ...
        uiTarget: 'Страница /dashboard/subscription',
