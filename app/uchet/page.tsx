  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {canCreateDoc && (
          <Link href="/uchet/documents/new" prefetch={true}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <Card className="lg:col-span-4 bg-card border-border backdrop-blur-xl p-6 space-y-4 shadow-2xl flex flex-col justify-between">
          ...
          <div className="space-y-2.5">
            {canViewDocs && (
              <Link href="/uchet/documents" prefetch={true} className="block">
            ...
            {canViewCounterparties && (
              <Link href="/uchet/counterparties" prefetch={true} className="block">
            ...
            {canViewFiles && (
              <Link href="/uchet/files" prefetch={true} className="block">
