...
const INSPECTOR_TABLES = [
  ...
  { id: 'documents', label: 'Таблица: documents (Первичка ЭДО)' },
  { id: 'files', label: 'Таблица: files (Файлы облака)' },
  { id: 'file_owners', label: 'Таблица: file_owners (CoW Владельцы)' },
