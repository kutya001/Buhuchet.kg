...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-blue-500 selection:text-white relative overflow-x-hidden font-sans">
      ...
      <header className="sticky top-3 sm:top-4 z-50 mx-2 sm:mx-6 md:mx-12 my-2 h-14 sm:h-16 rounded-2xl sm:rounded-3xl bg-card/80 backdrop-blur-xl border border-border shadow-2xl flex items-center justify-between px-3 sm:px-6 transition-all">
      ...
      <section className="px-3 sm:px-6 md:px-12 pt-6 sm:pt-10 pb-12 sm:pb-16 max-w-7xl mx-auto space-y-8 sm:space-y-12">
        <div className="text-center space-y-4 sm:space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-xs sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed break-words px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl bg-card hover:bg-muted text-foreground border border-border font-semibold text-sm sm:text-base transition-all flex items-center justify-center min-h-[48px]"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 pt-4">
          <div className="p-4 sm:p-5 rounded-2xl bg-card border border-border backdrop-blur-xl space-y-1">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">Мгновенный B2B обмен по ИНН</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-card border border-border backdrop-blur-xl space-y-1">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">Автосжатие фото на клиенте</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-card border border-border backdrop-blur-xl space-y-1">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">Облачный архив R2</p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-card border border-border backdrop-blur-xl space-y-1">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">Точечные роли сотрудников</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-3 sm:px-6 md:px-12 py-12 sm:py-20 max-w-7xl mx-auto space-y-10 sm:space-y-16">
        <div className="text-center space-y-3 max-w-3xl mx-auto px-2">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold text-foreground tracking-tight break-words">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-blue-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">Электронный документооборот</h3>
          ...
          {/* 2. Облачный архив */}
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-emerald-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">Облачный архив</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-purple-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">Гибкая ролевая модель</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-amber-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">Модерация Контрагентов</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-sky-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">Telegram Уведомления</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-card border border-border hover:border-indigo-500/40 transition-all space-y-4 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground">100% Mobile Ready</h3>
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
      ...
      <section className="px-3 sm:px-6 md:px-12 py-12 max-w-7xl mx-auto">
        <div className="p-6 sm:p-10 rounded-3xl bg-card border border-border backdrop-blur-2xl space-y-8 shadow-2xl">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <Badge variant="outline" className="border-amber-500/30 text-amber-400 bg-amber-500/10">
              Эффективность
            </Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight break-words">
      ...
      <section className="px-3 sm:px-6 md:px-12 py-12 max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-2xl bg-card border border-border space-y-2">
            <h4 className="font-bold text-foreground text-sm sm:text-base flex items-center">
